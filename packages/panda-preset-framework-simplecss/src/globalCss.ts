...
export const globalCss = (prefix: string) => {
	...
	return defineGlobalStyles({
		...
		html: {
			fontFamily: `{fonts.${prefix}.sans}`,
			scrollBehavior: 'smooth',
		},
		body: {
			backgroundColor: `{colors.${prefix}.bg}`,
			color: `{colors.${prefix}.text}`,
			fontSize: '1.15rem',
			lineHeight: '1.5',
			display: 'grid',
			...
			'& > header': {
				backgroundColor: `{colors.${prefix}.bg.accent}`,
			...
			'& > nav': {
				...
				'& a': {
					...
					'&:hover,&.current,&[aria-current="page"]': {
						borderColor: `{colors.${prefix}.accent}`,
						color: `{colors.${prefix}.accent}`,
						cursor: 'pointer',
					},
					[mobileCondition]: {
						border: 'none',
		...
		'button, .button, a.button, input[type="submit"], input[type="reset"], input[type="button"], label[type="button"]':
			{
				...
				color: `{colors.${prefix}.accent.text}`,
				lineHeight: 'normal',
				padding: '0.5rem 0.9rem',
				textDecoration: 'none',
			},
		'button[aria-disabled="true"], input:disabled, textarea:disabled, select:disabled, button[disabled]': {
			backgroundColor: `{colors.${prefix}.disabled}`,
			borderColor: `{colors.${prefix}.disabled}`,
			color: `{colors.${prefix}.text.light}`,
			cursor: 'not-allowed',
		},
		'input[type="range"]': {
			padding: 0,
		...
		'.button:not([aria-disabled="true"])': {
			_hover: {
				backgroundColor: `{colors.${prefix}.accent.hover}`,
				borderColor: `{colros.${prefix}.accent.hover}`,
				cursor: 'pointer',
			},
		},
		'button, input[type="submit"], input[type="reset"], input[type="button"], label[type="button"]': {
			_enabled: {
				_hover: {
					backgroundColor: `{colors.${prefix}.accent.hover}`,
					borderColor: `{colors.${prefix}.accent.hover}`,
					cursor: 'pointer',
				},
			},
		},

<script lang="ts">
  import { bodyData } from '$lib/actions/body-data';
  import { writable } from 'svelte/store';
  import type { SakuraPresetTheme } from '@amandaguthrie/panda-preset-framework-sakura';
  import { onMount } from 'svelte';

  /** Theme */

  const dataTheme = bodyData('sakuraTheme');

  const theme = writable('default');

  let selectTheme = 'default';

  function setTheme(newTheme: SakuraPresetTheme | string) {
    theme.set(`${newTheme}`);
  }
  ...
  onMount(() => {
    dialog = document.getElementById('dialog-demo') ? document.getElementById('dialog-demo') as HTMLDialogElement : null;
  });

  const showDialog = () => dialog ? dialog.showModal() : () => {
  };
</script>

<svelte:body use:dataTheme={$theme} />

<div id="top">
  <header>
    <h1>Sakura Test Page</h1>
    ...
    <select bind:value={selectTheme} on:change={() => setTheme(selectTheme)}>
      <option value="dark">Dark</option>
      <option value="dark-solarized">Dark Solarized</option>
    ...
    <section id="text">
      ...
      <article id="text__asides">
        ...
        <aside>
          ...
          <p>
            ...
            cumque numquam natus harum delectus autem, ipsam veritatis
            eligendi.
          </p>
        </aside>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rerum
          eligendi optio ipsa nemo assumenda mollitia inventore neque
          dolores animi ratione libero qui dolorem, distinctio aut, quae,
          iste, cumque nihil enim!
        </p>
        <p>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolorum
          perspiciatis corrupti eaque tempore autem doloremque, placeat, in
          earum ab maxime commodi tenetur quos provident fugit assumenda,
          consequatur vero ipsum, et.
        </p>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing, elit.
          Molestias, facilis. Dolores rerum omnis, adipisci odit ipsa, autem
          animi molestiae fugit temporibus fuga dignissimos, commodi et,
          itaque quo voluptatem recusandae voluptatibus.
        </p>
        <footer>
          <p><a href="#top">[Top]</a></p>
        </footer>
      ...
      <article id="text__lists">
        ...
        <dl>
          ...
          <dd>
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Voluptas, modi iure! Incidunt, dolorum sit? Dolorum cumque omnis
            accusantium doloremque nihil est perferendis voluptas delectus,
            quis aperiam blanditiis deleniti modi at. Lorem ipsum dolor sit
            amet consectetur adipisicing elit. Vel, perspiciatis, vero
            accusantium sed dicta exercitationem iure praesentium nobis esse
            ullam sunt cum blanditiis! Neque similique corporis animi
            voluptatibus et modi.
          </dd>
        </dl>
        <h3>Ordered List</h3>
        <ol type="1">
...
            <p><em>This text has added emphasis. But, it should not be displayed in a comment</em></p>-->
    ...
    <section id="embedded">
      ...
      <article id="embedded__images">
        ...
        <p>
          <img src="/kitten-480.jpg" alt="Photo of a kitten" />
        </p>
        <h3>
        ...
        <figure>
          <img src="/kitten-420.jpg" alt="Photo of a kitten" />
        </figure>
        <h3>
          <code>&lt;figure&gt;</code> element with
          <code>&lt;img&gt;</code> and
        ...
        <figure>
          <picture>
            <source srcset="/kitten-800.jpg" media="(min-width: 800px)" />
            <img src="/kitten-420.jpg" alt="Photo of a kitten" />
          </picture>
        </figure>
      ...
      <article id="embedded__bgimages">
        ...
        <figure
          style="
                background-image: url('/kitten-300.jpg');
                width: 300px;
                height: 300px;
              "
        ></figure>
      ...
      <article id="embedded__object">
        ...
        <object data="#" height="300" title="object"></object>
        <footer>
          <p><a href="#top">[Top]</a></p>
        </footer>
      </article>
      <article id="embedded__dialog">
        ...
        <dialog id="dialog-demo">
          <h2>Dialog</h2>
          <p>
            Dialogs are a new HTML5 element that can be used to create modal
            dialogs or pop-up windows.
          </p>
          <form method="dialog">
            <button>Close</button>
          </form>
    ...
    <section id="forms">
      ...
      <form>
        ...
        <fieldset id="forms__action">
          ...
          <p>
            <a href="#forms__action" class="button"
            >&lt;a class=button&gt;</a
            >
            <a href="#forms__action" class="button" aria-disabled="true"
            >&lt;a class=button aria-disabled=true&gt;</a
            >
          </p>
        </fieldset>
        <p><a href="#top">[Top]</a></p>
  ...
  <footer>
    <p>
      Based on
      <a href="http://github.com/cbracco/html5-test-page"
      >HTML5-test-page</a
      >
      by cbracco.
    </p>
